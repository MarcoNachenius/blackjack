...
class HardTotalStrategy(StrategyMatrix):
    """
    All hard total strategies have 10x17 matrixes.
    ...
    self.strategy_matrix[16] -> Strategy when hard total equals 5
    ...
    def __init__(self, starting_matrix: np.ndarray = None) -> None:
        super().__init__(width=10, height=17, starting_matrix=starting_matrix)
